<footer class="footer">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <img width="150" src="<?php echo base_url('');?>style/img/tut-wuri-handayani-7759.png" class="rounded" alt="Sekolah Dasar Negeri Serut">
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                ...
                                <p>SEKOLAH DASAR NEGERI SERUT</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                ...
                                <p>sekolahdasarnegeriserut@gmail.com</p>
                            </div>
                        </div>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> <a href="https://suryaciptainformatika.com/" target="_blank">Sekolah Negeri Serut</a> </p>
                        </p>
                    </div>
                </div>
            </div>
